...
**Operadores**
   ...
   construcciones, que veremos más adelante) puede variar dependiendo de si los
   valores atómicos están definidos (al haber usado el procesador una
   gramática) o indefinidos, o de si el procesador se corre en el modo
   compatible con la versión 1.0.

   ..  https://www.w3.org/TR/xpath-31/#id-backwards-compatibility

      .. Luego convendría ir analizando tipo de operador por tipo de operador.
