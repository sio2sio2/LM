...
expresiones se evalúan del mismo modo. La especificación añadió muchísimas más
funciones de las ya existentes, algunas novedosas construcciones y dos
redefiniciones conceptuales de suma importancia:
...
**Tipos**
   ...
   <https://commons.wikimedia.org/wiki/File:XQuery_and_XPath_Data_Model_type_hierarchy.png>`
   ...
   dato. De lo contrario, ya veremos cómo el tipo queda indefinido.
