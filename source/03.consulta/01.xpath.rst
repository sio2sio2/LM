...
.. caution:: A estas alturas aún, la lectura completa del siguiente epígrafe es
   ...
   validas únicas en *XPath* 3.0, o manejar la extensión de `Visual Studio
...
**Funciones**
   *XPath* ha ampliado muchísimo el número de funciones definidas (véase `XPath
   ...
   .. todo:: Explicar el `operador flecha
      <https://www.altova.com/training/xpath3/xpath-31#arrow-operator>`_.
     ...
     .. rst-class:: simple
        ...
        + ``fn:codepoints-to-string()`` y ``fn:string-to-codepoints()`` que
          ...
          .. note:: Ya hemos tratado los caracteres unicode al hablar de las
             ...
             en *XPath* deberemos escribir el código hexadecimal como :kbd:`0xd8`
             o directamente el código decimal equivalente (:kbd:`216`). Por
             tanto:
         ...
         .. note:: *XPath* no entiende el socorrido ":kbd:`\n`" para
