      ...
      #. Limite la velocidad máxima a **180**.
         ...
         .. rst-class:: sol-oculta
            ...
            .. code-block:: xquery
               ...
               where $vel > 180
               return
                  replace node $vel/text() with text {180}
      ...
      #. Añada un modelo "Mezcladito" que sea como el "Ibiza" pero con la
         ...
         .. rst-class:: sol-oculta
            ...
            .. code-block:: xquery
               ...
               modify (
                  replace node $mezcladito/@nombre with attribute nombre {"Mezcladito"},
                  replace node $mezcladito/@id with attribute id {fn:generate-id()},
                  replace node $mezcladito/cilindrada/text() with text {//modelo[@nombre ="León"]/cilindrada},
                  replace node $mezcladito/velmax/text() with text {//modelo[@nombre ="León"]/velmax}
               )
               return
