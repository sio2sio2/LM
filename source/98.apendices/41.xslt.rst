...
Practicando con |XSLT|
======================
Para transformar un |XML| mediante una hoja |XSLT| utilizaremos la misma
herramienta que se ha venido utilizando hasta ahora: :program:`xmlstarlet`. La
herramienta usa las librerías libxml2_ y libxslt_, de modo que sólo hay soporte
para XSLT v.1.0 y bastantes extensiones. La manera más sencilla de usarlo es
utilizar el argumento ``tr`` seguido de la hoja |XSLT| y el |XML| original:
